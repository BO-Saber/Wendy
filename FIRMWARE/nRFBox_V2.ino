...
void about() {
  ...
  u8g2.drawStr(0, 15, "Youtube/YellowPurple");
  u8g2.drawStr(21, 35, "Yellow Purple");
  u8g2.drawStr(0, 55, "Rubelymail@gmail.com");
  u8g2.sendBuffer();
}
...
void setup() {
  ...
  int16_t creditWidth = u8g2.getUTF8Width("Yellow Purple");
  int16_t creditX = (106 - creditWidth) / 2;
  u8g2.setCursor(creditX, 40);
  u8g2.print("Yellow Purple");
